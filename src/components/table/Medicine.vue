    ...
    <el-scrollbar>
      ...
      >
        ...
        <el-table-column
          ...
          :formatter="dateFormat"
        ></el-table-column>
        <el-table-column prop="createDatetime" label="操作" width="178" align="center">
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.forecast==1" type="text" @click="dataHandle(scope.row.id)" size="large">消耗趋势</el-button>
          </template>
        </el-table-column>
      </el-table>
      <br/>
